...
class FB_Creator
{
  ...
  public function set_renderer( FB_renderer $_renderer )
  {
  ...
  public function set_validator( FB_validator $_validator )
  {
  ...
  {
    $this->_form_structure['properties']['attributes'] = $this->_process_attributes($attributes, array('formbuilder', 'form'));
  ...
  public function add_checkbox ( $name = '', $label = '', $label_position = FB_R_CRB_LABEL_AFTER, $value = '', $checked = FALSE, $attributes=array(), $rules='' )
  {
    return $this->_add_field( array(
      'type' => 'checkbox',
      'name' => $name,
  ...
  public function add_checkboxes ( $name = '', $label = '', $label_position = FB_R_CRB_LABEL_AFTER, $options = array(), $attributes=array(), $rules='' )
  {
  ...
  public function add_radiobutton ( $name = '', $label = '', $label_position = FB_R_CRB_LABEL_AFTER, $value = '', $selected = FALSE, $attributes=array(), $rules='' )
  {
    return $this->_add_field( array(
      'type' => 'radiobutton',
      'name' => $name,
  ...
  public function add_radiobuttons ( $name = '', $label = '', $label_position = FB_R_CRB_LABEL_AFTER, $options = array(), $value = '', $attributes=array(), $rules='' )
  {
